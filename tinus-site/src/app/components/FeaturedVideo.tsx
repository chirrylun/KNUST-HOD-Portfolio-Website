          ...
          <AnimatePresence>
            {showVideo ? (
              ...
              >
                ...
                ></iframe>
                <motion.button
                  className="absolute top-4 right-4 bg-white/80 backdrop-blur-md p-2 rounded-full text-gray-800 hover:bg-white transition-colors"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    <motion.button
                      className="bg-white/90 backdrop-blur-md p-6 rounded-full text-primary hover:text-secondary transition-colors mb-6"
